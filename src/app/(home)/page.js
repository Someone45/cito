...
export default function Component() {
    ...
    const articles = sortedArticles.slice(0, 3).map((item, index) => {
    ...
    const teamMembers = [
        { id: 1, name: "Adriel Fung", description: "Adriel is a senior studying computer science at Queens College. He contributed towards front-end design, ML implementation, and database management.", imageUrl: "/dino.png" },
    ...
    async function processUserMessage() {
        ...
        console.log(`selectedArticle.fullText: ${selectedArticle.fullText}`)
